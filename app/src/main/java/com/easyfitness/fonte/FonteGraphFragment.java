...
public class FonteGraphFragment extends Fragment {
    ...
    public FonteGraphFragment() {
        Graph.zoomType currentZoom = Graph.zoomType.ZOOM_ALL;
    }
    ...
    private void drawGraph() {
        ...
        if (m.getType() == DAOMachine.TYPE_FONTE) {
            ...
            List<DateGraphData> valueList = mDbFonte.getBodyBuildingFunctionRecords(getProfile(), lMachine, lDAOFunction);
            ...
            // Recupere les enregistrements
            List<DateGraphData> valueList = mDbCardio.getFunctionRecords(getProfile(), lMachine, lDAOFunction);
